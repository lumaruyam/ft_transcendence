...
<!-- Responsible for: the project root README required by the subject (Chapter VI, "Readme Requirements") — team roles, project management, technical stack, DB schema, features, modules with point totals, and individual contributions. -->
...
<!-- TODO: Resources — references used, and a description of how AI was used and for which tasks (subject Chapter I / VI) -->
